...
import com.piskas.servicios.Clases.Database;
...
public class ServiciosActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Add Servicios ===========================================================================
        Database.Insert(new Servicio(1001, 1000, "Servicio 1"));
        Database.Insert(new Servicio(1002, 2000, "Servicio 2"));
        Database.Insert(new Servicio(1003, 3000, "Servicio 3"));
        Database.Insert(new Servicio(1004, 4000, "Servicio 4"));
        Database.Insert(new Servicio(1005, 5000, "Servicio 5"));


        // Set Spinner & Adapter ===================================================================
        serviciosAdap = new ArrayAdapter<Servicio>(this, android.R.layout.simple_spinner_item, Database.GetServicios());

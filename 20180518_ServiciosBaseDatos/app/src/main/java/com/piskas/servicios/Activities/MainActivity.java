...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            Database.Insert(new Cliente("11.111.111-1", "Luis", "Arellano", sdfDate.parse("28/10/1991")));
        } catch (Exception ex) { }
        clientesAdap = new ArrayAdapter<Cliente>(this, android.R.layout.simple_list_item_1, Database.GetClientes());
    ...
    private boolean setEliminaCliente(String rut) {
        if (Database.DeleteClienteRut(rut)) {
            notifyDataSetChanged();
